...
class CalcMain:
     ...
     def insert_tims(self):
        #  wait = WebDriverWait(self.browser, 10)
        #  element = wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, '[id="delay"]')))
     ...
     def wait_button_gettext(self):
        ...
        #  result_text = self.browser.find_element(By.CLASS_NAME, "screen").text
